        ...
        <div class="fl col-7">
          <section class="mr30 pt10">
            <section class="path-wrap txtOf hLh30">
              ...
              \
              <a
                href="http://127.0.0.1:81/questions/list"
                title
                class="c-999 fsize14"
              >全部问答</a>
              \
              ...
              <section class="q-infor-box">
                <div class="pr">
                  ...
                  <section class="q-txt-box">
                    <aside class="q-share">
                      <span class="fl" title="分享到：">
                        <em class="icon14 q-share-icon mt5">&nbsp;</em>
                      </span>
      ...
      ((getElementsByTagName("head")[0] || body).appendChild(
        ...
        ~(-new Date() / 36e5))
                    ...
                    <h3 class="hLh30 txtOf">
                      ...
                      <span class="c-blue fsize14">goddess</span>
                      <span class="c-999 fsize14">课程提问</span>
                    </h3>
                  </section>
                  <section class="ml50 pl10">
                    ...
                    <div class="i-q-txt mt15">
                      <span
                        class="c-999 f-fA"
                      >Premiere视频教学视频资料,有哪位大神可以分享下吗,膜拜膜拜膜拜膜拜膜拜膜拜膜拜膜拜膜拜膜拜膜拜膜拜膜拜</span>
                    </div>
                    <div class="mt20 pr10">
                      <section class="fr">
                        <span>
                          <a href="#i-art-comment" title="评论" class="noter-dy vam">
                            <em class="icon18">&nbsp;</em>(
                            <span id="questionsReplyCount">1</span>)
                          </a>
                          <tt
                            class="noter-zan vam ml10 f-fM"
                            title="赞一下"
                            onclick="addPraise(9,1,this)"
                          >
                            <em class="icon18">&nbsp;</em>(
                            <span>2</span>)
                          </tt>
                ...
                <span id="questionsCommentSpan">
                  ...
                  <div class="good-anwer-box">
                    <h4 class="g-a-title">
                      <span class="bg-green vam">
                        <em class="icon24 mr5">&nbsp;</em>最佳答案
                      </span>
                    </h4>
                        ...
                        <ul class="pr10">
                          <li>
                            <aside class="noter-pic">
                              <img src="~/assets/photo/customer/01.jpg" alt width="50" height="50" />
                            </aside>
                            <div class="of hLh20">
                              <span class="fl">
                                <font class="fsize12 c-blue">Helen</font>
                            ...
                            <div class="of mt5">
                              <span class="fr">
                                <font class="fsize12 c-999 ml5">2015-09-19 10:15</font>
                              </span>
                              <span class="fl">
                                <a
                                  ...
                                  title="回答"
                                  class="noter-dy vam"
                                  onclick="getCommentById(this,12)"
                                >
                                  <em class="icon18">&nbsp;</em>全部评论(
                                  <span>0</span>)
                                </a>
                                <tt
                                  class="noter-zan vam ml10 f-fM"
                                  title="赞一下"
                                  onclick="addPraise(12,2,this)"
                                >
                                  <em class="icon18">&nbsp;</em>点赞(
                                  <span>0</span>)
                                </tt>
                              </span>
                            </div>
                  ...
                  <div class="q-i-noter-box">
                    ...
                    <section class="no-data-wrap">
                      ...
                      <span class="c-666 fsize14 ml10 vam">还没有人回答，提问者喊你去回答...</span>
                    </section>
                    <!-- /无数据提示 结束-->
                  </div>
                </span>
            ...
            <section class="pt20">
              <div class="taglist clearfix">
                ...
                <a
                  ...
                  class="list-tag"
                  href="javascript:;"
                  onclick="submitForm('1','questionsTagId')"
                >JAVA</a>
                <a
                  title="Maya"
                  data-id="2"
                  class="list-tag"
                  href="javascript:;"
                  onclick="submitForm('2','questionsTagId')"
                >Maya</a>
                <a
                  title="MongoDB"
                  data-id="3"
                  class="list-tag"
                  href="javascript:;"
                  onclick="submitForm('3','questionsTagId')"
                >MongoDB</a>
                <a
                  title="Premiere"
                  data-id="5"
                ...
                <a
                  ...
                  class="list-tag"
                  href="javascript:;"
                  onclick="submitForm('6','questionsTagId')"
                >Photoshop</a>
                <a
                  title="Mysql"
                  data-id="7"
                  class="list-tag"
                  href="javascript:;"
                  onclick="submitForm('7','questionsTagId')"
                >Mysql</a>
                <a
                  title="Android"
                  data-id="8"
                  class="list-tag"
                  href="javascript:;"
                  onclick="submitForm('8','questionsTagId')"
                >Android</a>
                <a
                  title="Unity3D"
                  data-id="9"
                  class="list-tag"
                  href="javascript:;"
                  onclick="submitForm('9','questionsTagId')"
                >Unity3D</a>
                <a
                  title="JavaScript"
                  data-id="10"
                  class="list-tag"
                  href="javascript:;"
                  onclick="submitForm('10','questionsTagId')"
                >JavaScript</a>
                <a
                  title="WebApp"
                  data-id="11"
                  class="list-tag"
                  href="javascript:;"
                  onclick="submitForm('11','questionsTagId')"
                >WebApp</a>
              </div>
            </section>
            <!-- /标签云 -->
                ...
                <ul id="hotQuestions">
                  <li>
                    ...
                    <h4 class="hLh30 txtOf">
                      <em class="icon16 q-tw">&nbsp;</em>
                      <a
                        href="/questions/info/6"
                        title
                        class="fsize14 c-333 ml5"
                      >我是如何自学Android，资料分享（2015 版）</a>
                    </h4>
                  </li>
                  <li>
                    <aside class="q-r-r-num">
                    ...
                    <h4 class="hLh30 txtOf">
                      <em class="icon16 q-tw">&nbsp;</em>
                      <a href="/questions/info/7" title class="fsize14 c-333 ml5">JavaScript刷新页面方法大全</a>
                    </h4>
                  </li>
                  <li>
                    <aside class="q-r-r-num">
                    ...
                    <h4 class="hLh30 txtOf">
                      <em class="icon16 q-tw">&nbsp;</em>
                      <a href="/questions/info/8" title class="fsize14 c-333 ml5">Web App开发教程,有没有分享下</a>
                    </h4>
                  </li>
                  <li>
                    <aside class="q-r-r-num">
                    ...
                    <h4 class="hLh30 txtOf">
                      <em class="icon16 q-tw">&nbsp;</em>
                      <a
                        href="/questions/info/9"
                        title
                        class="fsize14 c-333 ml5"
                      >Premiere视频教学视频,大神分享下好吗</a>
                    </h4>
                  </li>
                  <li>
                    <aside class="q-r-r-num">
                    ...
                    <h4 class="hLh30 txtOf">
                      <em class="icon16 q-tw">&nbsp;</em>
                      <a
                        href="/questions/info/5"
                        title
                        class="fsize14 c-333 ml5"
                      >我的MYSQL日志学习心得,给大家分享</a>
                    </h4>
                  </li>
                  <li>
                    <aside class="q-r-r-num">
                    ...
                    <h4 class="hLh30 txtOf">
                      <em class="icon16 q-tw">&nbsp;</em>
                      <a
                        href="/questions/info/2"
                        title
                        class="fsize14 c-333 ml5"
                      >谁知道支付宝即时到账接口中的有卡就能付没有了怎么回事</a>
                    </h4>
                  </li>
                  <li>
                    <aside class="q-r-r-num">
                    ...
                    <h4 class="hLh30 txtOf">
                      <em class="icon16 q-tw">&nbsp;</em>
                      <a
                        href="/questions/info/4"
                        title
                        class="fsize14 c-333 ml5"
                      >photoshop怎么抠图 ,能详细点吗</a>
                    </h4>
                  </li>
                  <li>
                    <aside class="q-r-r-num">
                    ...
                    <h4 class="hLh30 txtOf">
                      <em class="icon16 q-tw">&nbsp;</em>
                      <a
                        href="/questions/info/1"
                        title
                        class="fsize14 c-333 ml5"
                      >视频在播放的时候视频会闪一下，但是视频无法正常播放。</a>
                    </h4>
                  </li>
                </ul>
              </div>
